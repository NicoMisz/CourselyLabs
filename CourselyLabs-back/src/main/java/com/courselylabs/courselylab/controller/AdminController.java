...
public class AdminController {
    ...
    public ResponseEntity<Map<String, Object>> grantPremium(
        ...
        if (expiresAtStr == null || expiresAtStr.isBlank()) {
            return ResponseEntity.badRequest().body(Map.of("message", "Se requiere fecha de expiracion"));
        }
        var sub = adminService.grantPremium(id, java.time.LocalDateTime.parse(expiresAtStr));
    ...
    public ResponseEntity<Void> revokePremium(@PathVariable UUID id) {
        adminService.revokePremium(id);
