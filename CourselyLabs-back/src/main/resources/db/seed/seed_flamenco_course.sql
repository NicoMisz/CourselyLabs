...
DECLARE
  cat_id       INTEGER;
  course_id    UUID;
  instructor   UUID := '096d025d-f50b-4d2c-8f01-565c3be578a2'; -- Joan Garcia
  student1     UUID := '2245c8f1-4ff1-4235-a918-f38bf193fe9d'; -- Maria Lopez
  student2     UUID := '5b1c23f7-9281-4bf7-b164-b169b01f83dd'; -- Sara Martin
  enroll1      UUID;
  enroll2      UUID;
